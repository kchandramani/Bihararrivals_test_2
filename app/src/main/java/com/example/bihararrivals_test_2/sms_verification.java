...
import com.example.bihararrivals_test_2.databinding.ActivitySmsVerificationBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvResendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(sms_verification.this, "OTP Send Successfully.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (binding.etC1.getText().toString().trim().isEmpty() ||
                    ...
                    Toast.makeText(sms_verification.this, "OTP is not Valid!", Toast.LENGTH_SHORT).show();
                } else {
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            binding.progressBarVerify.setVisibility(View.VISIBLE);
                                            binding.btnVerify.setVisibility(View.INVISIBLE);
                                            Toast.makeText(sms_verification.this, "Welcome...", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(sms_verification.this, search_guide.class);
